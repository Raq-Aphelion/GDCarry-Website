import { Coins, Gamepad2, Globe, Package, ShieldCheck, SquareCheck, Swords, Trophy, type LucideIcon } from 'lucide-react';
...
export const SERVICE_TAG_ICONS: Record<string, [LucideIcon, LucideIcon, LucideIcon]> = {
  ...
  'ffxiv-savage-tier': [Package, SquareCheck, Gamepad2],
